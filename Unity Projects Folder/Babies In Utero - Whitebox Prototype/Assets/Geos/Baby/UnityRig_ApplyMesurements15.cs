...
public class UnityRig_ApplyMesurements15 : MonoBehaviour
{
    [Header("Measurements")]
    ...
    public void Update()
    {
        ...
        //Average 15-Week Child Sizes
        float avgHight = 16.4f;
        //float avgHeadCircumference = 44.21f;
        float avgHeadMajorDiameter = 3.65f;
        float avgHeadMinorDiameter = 2.73f;
        float avgHeadToRump = (10.48f-avgHeadMajorDiameter)/4;
        float avgArmLength = 5.92f/2;
        float avgLegLength = 5.92f/2;
